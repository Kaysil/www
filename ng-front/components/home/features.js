		...
		<Container center padding>
			...
			<div className="row">
				<div className="column">
					...
					<p>
						Chat with other players, submit feedback, appeal punishments, apply
						for staff, get the latest news, and more!
					</p>
				...
				<div className="column">
					...
					<p>
						Unlock your pet companions, beautiful particle effects, your desired
						kit, ability to fly in the lobby to explore and more plots.
					</p>
				...
				<div className="column">
					...
					<p>
						Feel we're a great server? Vote now – if you become the top voter of
						the month you could win a FREE rank upgrade!
					</p>
