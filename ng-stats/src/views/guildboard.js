...
function createData(name, leader, level, xp) {
	return { name, leader, level, xp }
}
...
class Guildboard extends Component {
	...
	render() {
		...
		const rows = stats.map((stat) =>
			createData(stat.player, stat.rank, stat.level, stat.xp),
		)
...
export default withStyles(styles)(Guildboard)
